...
<table cellspacing='0' cellpadding='6' border='1' bordercolor='#c2c2c2' width='100%'>
  ...
  <c:set var="dummyflag" value="true"/>
    ...
    <tr>
        ...
        <td width='30%' class='fieldvalue' align='center' nowrap> <c:out value="${qrow[3]}"/><c:if test="${empty qrow[3]}">&nbsp;</c:if> </td>
        <td width='30%' class='fieldvalue' align='center' nowrap> <c:out value="${qrow[2]}"/><c:if test="${empty qrow[2]}">&nbsp;</c:if> </td>
        <td width='10%' class='fieldvalue' align='center' nowrap> <c:out value="${qrow[1]}"/><c:if test="${empty qrow[1]}">&nbsp;</c:if> </td>
        <td width='30%' class='fieldvalue' align='center' nowrap> <c:out value="${qrow[8]}"/><c:if test="${empty qrow[8]}">&nbsp;</c:if> </td>
        <td width='20%' class='fieldvalue' align='center' nowrap> <c:out value="${qrow[5]}"/><c:if test="${empty qrow[5]}">&nbsp;</c:if> </td>
        <td width='10%' class='fieldvalue' align='center' nowrap> <c:out value="${qrow[4]}"/><c:if test="${empty qrow[4]}">&nbsp;</c:if> </td>
        <td width='20%' class='fieldvalue' align='center' nowrap> <c:out value="${qrow[6]}"/><c:if test="${empty qrow[6]}">&nbsp;</c:if> </td>
